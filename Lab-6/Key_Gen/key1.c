// Generating keys in three different ways: explicit, ftok(), and system generated (IPC_PRIVATE)
...
int main(){
	...
	key_t key2;
	// key2=ftok("/home/badrul/Desktop/IPC_Lab/Key_Gen",'r');  // File path change korte hobe
	key2=ftok("home/Desktop/lab6/Key_Gen",'m');
	if(key2==(key_t)-1){
